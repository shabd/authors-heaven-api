...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("phone number"), max_length=30, default="+27784123456"
    )
    ...
    country = CountryField(
        verbose_name=_("country"), default="ZA", blank=False, null=False
    )
    ...
    # we want all the follows a user have , so we revers it , by using the related name
    ...
    #  we use reverse relationship by using the related_name
